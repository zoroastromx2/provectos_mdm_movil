...
public:
     ...
     *
     * NOTA: Esta operaci�n es ahora ASINCR�NICA (v0.2.0+).
     * El m�todo retorna inmediatamente; el resultado llega v�a signal
     * generationSucceeded() cuando termina, o lastError si falla.
     * Usa la propiedad busy para indicar operaci�n en progreso.
     *
